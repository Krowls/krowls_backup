...
const Contact = () => {
    return (
        <>
            <SEO title="Blog Grid" />
            {/* <ColorSwitcher /> */}
            <main className="main-wrapper bg-color-dark">
                <HeaderOne />
                <BreadCrumbOne 
                title="Contact"
                page="Contact"
                    ...
                    <div className="row">
                        <div className="col-xl-5 col-lg-6">
                            <div className="contact-form-box shadow-box mb--30">
                                <h3 className="title">Get a free Krowls quote now</h3>
                                <FormTwo />
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-6 offset-xl-1">
                            <div className="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
                                ...
                                <p>We Are Availble 24/7</p>
                                <h4 className="phone-number"><a href="tel:+919030367334">(+91) 9030367334</a></h4>
                            </div>
                            <div className="contact-info mb--30">
                                <h4 className="title">Email</h4>
                                <p>Our support team will get back to in 48-h during standard business hours.</p>
                                <h4 className="phone-number"><a href="mailto:contact@krowls.com">contact@krowls.com</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
