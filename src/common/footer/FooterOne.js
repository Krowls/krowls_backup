                ...
                <div className="footer-top">
                    <div className="footer-social-link">
                        <ul className="list-unstyled">
                            <li><Link to="https://www.facebook.com/profile.php?id=100090756235276"><FaFacebookF /></Link></li>
                            <li><Link to="https://twitter.com/Krowls3"><FaTwitter /></Link></li>
                            <li><Link to="https://in.pinterest.com/krowlsdesign/"><FaPinterestP /></Link></li>
                            <li><Link to="https://www.linkedin.com/company/krowls/"><FaLinkedin /></Link></li>
                            <li><Link to="https://www.instagram.com/krowls.design/"><FaInstagram /></Link></li>
                            {/* <li><Link to="https://vimeo.com/"><FaVimeoV /></Link></li> */}
                            <li><Link to="https://dribbble.com/krowls"><FaDribbble /></Link></li>
                            <li><Link to="https://www.behance.net/krowls"><FaBehance /></Link></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()}. All rights reserved by <a href="https://www.krowls.com/">Krowls</a>.</span>
                            </div>
                        </div>
                        <div className="col-md-6">
