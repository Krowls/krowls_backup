    ...
    return (
        <div className="section section-padding-equal bg-color-dark">
            ...
            <SectionTitle 
                subtitle="------"
                title="Our Projects"
                description="It is the process that makes our work so much fun, but our greatest joy comes from helping our partners achieve impactful results. Have a look around!"
